function scr_date_and_time(_time) {
	...
	*/
	...
	switch (_day_counter) {
		...
		case 0: _day_name = "Mon."; break;
		case 1: _day_name = "Tue."; break;
		case 2: _day_name = "Wed."; break;
		case 3: _day_name = "Thu."; break;
		case 4: _day_name = "Fri."; break;
		case 5: _day_name = "Sat."; break;
		case 6: _day_name = "Sun."; break;
		default: _day_name = "Mon."; break;
	}
...
function get_current_day() {
	var _day_counter = global.day_counter;
	var _day_name = "";
...
function get_current_time(_time) {
	var _actual_hour, _actual_minutes, _hour_progress, _day_counter = 0;
	var _str_hour, _str_minutes, _str_output, _day_name = "";
	...
	// combine vars to create the final output string e.g. "Monday 14:32"
	_str_output = _str_hour + ":" + _str_minutes;
