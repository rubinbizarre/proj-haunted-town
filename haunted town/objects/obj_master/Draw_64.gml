...
if (global.debug) {
	...
	if (instance_exists(obj_manager_time)) draw_text_transformed(_x, _y, "time_speed: "+string(obj_manager_time.time_speed * obj_manager_time.time_speed_multiplier), 2, 2, 0); _y += _ysep;
